...
const CheckoutSchema = z.object({
  ...
  preferredGateway: z.enum(['RAZORPAY', 'PAYPAL', 'RAZORPAY_INTERNATIONAL_BANK_TRANSFER_NATIVE', 'RAZORPAY_INTERNATIONAL_BANK_TRANSFER_SWIFT']).optional(),
  whatsapp: z.string().max(25).regex(/^(\+?[\d\s\-()]+)?$/, 'Invalid format').optional().or(z.literal('')),
