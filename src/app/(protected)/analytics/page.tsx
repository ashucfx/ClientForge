      ...
      <div className="w-full max-w-7xl 2xl:max-w-[1680px] mx-auto px-3 sm:px-6 lg:px-10 py-6 sm:py-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
            <input
              type="month"
              className="w-full sm:w-auto min-w-[190px] px-4 py-2.5 rounded-xl border border-slate-200 text-sm font-semibold text-slate-800 focus:outline-none focus:ring-2 focus:ring-[#B8935B] bg-white transition-all shadow-xs"
              value={monthFilter}
              onChange={(e) => setMonthFilter(e.target.value)}
            />
            <Link
              href="/analytics/sources"
              className="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-[#B8935B] text-white text-xs sm:text-sm font-semibold rounded-lg hover:bg-[#9A7540] transition-colors shadow-sm shrink-0"
            >
              <span>🔍</span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#0A0B0D] via-[#1C1812] to-[#2D2418] text-white p-5 sm:p-6 shadow-md border border-[#B8935B]/30 flex flex-col justify-between col-span-1 lg:col-span-1">
                <div className="flex justify-between items-start mb-3">
                  ...
                  <span className="text-[10px] px-2 py-0.5 rounded-full font-extrabold uppercase bg-emerald-500/20 text-emerald-300 border border-emerald-500/30">
                    Exact Ledger
                  </span>
                </div>
                <div>
            ...
            <div className="bg-white rounded-2xl p-5 sm:p-8 border border-slate-200/80 shadow-xs">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                ...
                <div className="bg-slate-50 p-4 rounded-xl border border-slate-100">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="text-xl sm:text-2xl font-extrabold text-slate-900">
                      {formatCurrency(execData?.revenue?.periodValue || 0, '₹')}
                    </div>
                    {execData?.revenue?.trendPct !== undefined && (
